...
namespace Leap.Unity {
  ...
  public class CapsuleHand : IHandModel {
    ...
    private static Color[] _leftColorList = { new Color(0.5f, 0.5f, 0.5f), new Color(0.5f, 0.5f, 0.5f), new Color(0.5f, 0.5f, 0.5f) };
    private static Color[] _rightColorList = { new Color(0.5f, 0.5f, 0.5f), new Color(0.5f, 0.5f, 0.5f), new Color(0.5f, 0.5f, 0.5f) };
